...
<head>
	...
	<link rel="stylesheet" href="assets/style/test-slider.css">
...
<body>
	...
	<section class="home-companies">
		<div class=" container text-center">
			<img src="assets/img/home/companies.png" class="img-responsive">
		</div>
	</section>
        ...
        <div class="testimonial-heading">
            ...
            <div class="flexslider1">
              <ul class="slides new-slides">
                ...
                <li data-thumb="assets/img/home/testimations/test-6.png">
                    <p>Lorem ipsum dolor sit amet, quam mi. Enim diam molestie scelerisque habitant vestibulum ut, ornare quisque libero a. Montes penatibus, venenatis elit doloribus, sit nulla ut dapibus vestibulum.
                      <span>Lorraine Anderson</span>
                    </p>
                </li>
                <li data-thumb="assets/img/home/testimations/test-7.png">
                    <p>Lorem ipsum dolor sit amet, quam mi. Enim diam molestie scelerisque habitant vestibulum ut, ornare quisque libero a. Montes penatibus, venenatis elit doloribus, sit nulla ut dapibus vestibulum.
                      <span>Lorraine Anderson</span>
                    </p>
                </li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 wow fadeInRight">
					<img src="assets/img/home/home1.png" class="img-responsive">
				</div>
			</div>
		</div>		
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 wow fadeInUp">
					<img src="assets/img/home/home2.png" class="img-responsive">
				</div>
				<div class="col-md-6 wow fadeInRight">
					<br><br>
					<h2 class="text-blue">Lorem ipsum dolor sit amet</h2>
	...
	<section class="bg-blue home-bar">
		<div class="container text-center">
	...
	<section class="home-section">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 wow fadeInRight">
					<img src="assets/img/home/home3.png" class="img-responsive">
				</div>
			</div>
		</div>		
	</section>
	...
	<section class="home-section">
		<div class="container">
			<div class="row">
				<div class="col-md-6 wow fadeInUp">
					<img src="assets/img/home/home4.png" class="img-responsive">
				</div>
				<div class="col-md-6 wow fadeInRight">
					<br><br>
					<h2 class="text-blue">Lorem ipsum dolor sit amet</h2>
	...
	<footer>
		<div class="container text-center">
			<img src="assets/img/favicon.png" class="footer-logo">
			...
			<div class="text-muted copyright">Copyright&copy;TendorBooks, All right reserved.</div>			
		</div>
	</footer>
